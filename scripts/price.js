    ...
    content.innerHTML = `
        ...
        <div style="display: grid; gap: 20px; margin-top: 20px;">
            <div class="price-list-container" style="padding: 15px; border: 1px solid #ddd; border-radius: 5px;">
                ...
                <div class="price-item" onclick="window.open('price-lists/Пюрешки Olmish.pdf', '_blank')" style="cursor: pointer; margin-top: 15px; display: flex; align-items: center;">
                    <i class="fas fa-file-pdf" style="color: #dc3545; margin-right: 10px;"></i>
                    <span style="flex: 1;">Пюрешки Olmish</span>
                </div>
            </div>
        </div>
    `;
